...
exports.userIncidentController = {
    ...
    async getUserIncidents(req, res) {
        try {
            ...
            const incidents = await incidentService_1.incidentService.getUserIncidents(userId, limit, offset);
            const stats = await incidentService_1.incidentService.getIncidentStats(userId);
            res.json({
                success: true,
                data: {
                    incidents,
    ...
    async getIncident(req, res) {
        try {
            const { id } = req.params;
            const userId = req.userId;
            const incident = await incidentService_1.incidentService.getIncidentById(id, userId);
            if (!incident) {
                res.status(404).json({
                    success: false,
    ...
    async markViewed(req, res) {
        try {
            const { id } = req.params;
            const userId = req.userId;
            await incidentService_1.incidentService.markIncidentViewed(id, userId);
            res.json({
                success: true,
    ...
    async createDispute(req, res) {
        try {
            ...
            const dispute = await incidentService_1.incidentService.createDispute({
                reportId: id,
                userId,
                disputeType,
                description,
    ...
    async updateNote(req, res) {
        try {
            ...
            const incidentNote = await incidentService_1.incidentService.addIncidentNote({
                reportId: id,
                userId,
                note
            });
    ...
    async markNotificationRead(req, res) {
        try {
            const { id } = req.params;
            const userId = req.userId;
            await notificationService_1.notificationService.markAsRead(id, userId);
            res.json({
                success: true,
    ...
    async updateNotificationPreferences(req, res) {
        try {
            ...
            const updatedPreferences = await notificationService_1.notificationService.updatePreferences(userId, preferences);
            res.json({
                success: true,
